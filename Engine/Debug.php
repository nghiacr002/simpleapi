            ...
            if ( $init) {
                if ( ! self::$registered )
                    self::$registered = array(
                        ...
                        , 'shutdown'        => register_shutdown_function( '\API\Engine\Debug::shutdown' )
                    );
                self::$registered[ 'shutdown' ] = true;
                error_reporting( E_ALL );
                set_error_handler( '\API\Engine\Debug::handler', E_ALL );
                set_exception_handler( '\API\Engine\Debug::exception' );
