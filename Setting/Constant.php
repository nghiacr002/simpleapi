...
define('API_PUBLIC_PATH',API_PATH . 'Public'. API_DS);
define('API_UPLOAD_PATH',API_PUBLIC_PATH . 'Upload'. API_DS);
define('API_CACHE_PATH',API_PUBLIC_PATH . 'Cache'. API_DS);
define('API_META_PATH',API_PUBLIC_PATH . 'Meta'. API_DS);
define('API_CLIENT_PATH',API_PUBLIC_PATH . 'Client'. API_DS);
define('API_LOG_PATH',API_PUBLIC_PATH . 'Log'. API_DS);
define('API_DEFAULT_PASSWORD','123456');
